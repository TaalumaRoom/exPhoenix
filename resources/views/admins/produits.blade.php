...
<body>
                    ...
                    <div class="tab-pane fade show active" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">
                        <div class="row">
                            ...
                            <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12">
                                ...
                                <a href="#" class="genric-btn primary" style="text-align: left;" data-toggle="modal" data-target="#produitstock">Ajouter un produit</a><br>
                                ...
                                <br><table id="example1" class="table table-bordered table-striped" style="text-align: center; font-family: Gill sans Mt;">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>2011-04-25</td>
                                            <td>
                                                <a href="#" class="delete"><button style="background: rgb(0, 102, 255); border-radius: 5px; color: white; width: 30px; border: 2px white solid; text-align: center;"><span class="fa fa-plus"></span></button></a>
                                                ...
                                                <a href="#" class="delete"><button style="background: rgb(214, 218, 42); border-radius: 5px; color: white; width: 30px; border: 2px white solid; text-align: center;"><span class="fa fa-arrow-alt-circle-up"></span></button></a>

                                                <a href="#" class="delete"><button style="background: rgb(249, 165, 15); border-radius: 5px; color: white; width: 30px; border: 2px white solid; text-align: center;"><span class="fa fa-arrow-alt-circle-down"></span></button></a>

                                                <a href="#" class="delete"><button style="background: rgb(140, 144, 218); border-radius: 5px; color: white; width: 30px; border: 2px white solid; text-align: center;"><span class="fa fa-arrow-alt-circle-right" data-toggle="modal" data-target="#promotion"></span></button></a>
    ...
    <div class="modal" id="produitstock">
      <div class="modal-dialog">
        <div class="modal-content">

          <div class="modal-header">
            <h4 class="modal-title" style="font-family: Gill sans Mt; text-transform: uppercase;">Ajouter un produit</h4>
                        ...
                        <div class="row">                                    
                            ...
                            <div class="col-lg-12">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="NomProduit" placeholder="Nom du Produit" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;">
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="Quantite" placeholder="Quantité du Produit" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;">
                                </div>
                            </div>

                            <div class="col-lg-12">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="Categorie" placeholder="Categorie du Produit" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;">
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="input-group mb-3">
                                    <input type="text" class="form-control" name="Prix" placeholder="Prix Unitaire du Produit" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;">
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="input-group mb-3">
                                    <select class="form-control" name="Devise" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;">
                            ...
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label style="font-family: Gill sans Mt; font-size: 15px;">Uploader la première photo</label>
                                    <input type="file" class="form-control" name="Photo1" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;" required>
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label style="font-family: Gill sans Mt; font-size: 15px;">Uploader la deuxième photo</label>
                                    <input type="file" class="form-control" name="Photo2" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;" required>
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label style="font-family: Gill sans Mt; font-size: 15px;">Uploader la troisième photo</label>
                                    <input type="file" class="form-control" name="Photo3" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;" required>
                                </div>
                            </div>

                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label style="font-family: Gill sans Mt; font-size: 15px;">Uploader la quatrième photo</label>
                                    <input type="file" class="form-control" name="Photo4" style="box-shadow: none; font-size: 13px; border-radius: 4px; font-family: Gill sans Mt;" required>
                                </div>
                            </div>
                            ...
                            <div class="text-center" style="text-align: center;"> 
                                <a href="#" class="genric-btn info-border circle" style="text-align: center;">Ajouter le produit</a>
                            </div>
                    </form>
                  </div>
