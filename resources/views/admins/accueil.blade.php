                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">Faites votre choix  </h1>
                                    <p data-animation="fadeInLeft" data-delay=".7s" data-duration="2000ms">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat is aute irure.</p>
                                    <!-- Hero-btn -->
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="industries.html" class="btn hero-btn">Achetez maintenant </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="/design/assets/img/hero/watch.png" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="/design/assets/img/gallery/new_product1.png" alt="">
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="/design/assets/img/gallery/new_product2.png" alt="">
                            </div>
                            <div class="product-caption">
                                <h3><a href="/product_details">Thermo Ball Etip Gloves</a></h3>
                                <span>$ 45,743</span>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-new-pro mb-30 text-center">
                            <div class="product-img">
                                <img src="/design/assets/img/gallery/new_product3.png" alt="">
                            </div>
                            <div class="product-caption">
                                <h3><a href="product_details">Thermo Ball Etip Gloves</a></h3>
                                <span>$ 45,743</span>
                                <a href="/connexion"><span class="flaticon-message"></span></a> 
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                              <div class="row">
                                ...
                                <div class="col-md-6 col-lg-3 col-xl-3 border-sm-start-none border-start">
                                  ...
                                  <h6 class="text-success">réduction</h6>
                                  <div class="d-flex flex-column mt-4">
                                    
                                    <button class="btn btn-primary btn-sm" type="button"><a href="/product_details">Details</a></button>
                                    <button class="btn btn-outline-primary btn-sm mt-2" type="button">
                                      <a href="/connexion">Acheter</a>
                                    </button>
                                  </div>
                                </div>
                              </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="/design/assets/img/gallery/popular1.png" alt="">
                                <div class="img-cap">
                                    <span> <a> <a href="/product_details">Acheter</a> </a>     </span>
                                </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="/design/assets/img/gallery/popular2.png" alt="">
                                <div class="img-cap">
                                    <span><a> <a href="/product_details">Acheter</a> </a></span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="/design/assets/img/gallery/popular3.png" alt="">
                                <div class="img-cap">
                                    <span><a> <a href="/product_details">Acheter</a> </a></span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="/design/assets/img/gallery/popular4.png" alt="">
                                <div class="img-cap">
                                    <span><a> <a href="/product_details">Acheter</a> </a></span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="/design/assets/img/gallery/popular5.png" alt="">
                                <div class="img-cap">
                                    <span><a> <a href="/product_details">Acheter</a> </a></span>
                                </div>
                                <div class="favorit-items">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        <div class="single-popular-items mb-50 text-center">
                            <div class="popular-img">
                                <img src="/design/assets/img/gallery/popular6.png" alt="">
                                <div class="img-cap">
                                    <span><a> <a href="/product_details">Acheter</a> </a></span>
                                </div>
                                <div class="favorit-items">
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-70">
                        <a href="/shop" class="btn view-btn1">Voir Plus </a>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="subscribe_part_content">
                            <h2>Obtenez des  promotions & Mise à  jour!</h2>
                            <p>Seamlessly empower fully researched growth strategies and interoperable internal or “organic” sources credibly innovate granular internal .</p>
                            <div class="subscribe_form">
                                <input type="email" placeholder="Entre votre mail">
                                <a href="#" class="btn_1">souscrivez </a>
                            </div>
                        </div>
                    </div>
                </div>
