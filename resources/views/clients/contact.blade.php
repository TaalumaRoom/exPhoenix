...
<head>
  ...
  <title>Taaluma Afrika | Client | Contact</title>
    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <li><a class="nav-link scrollto active" href="/client/contact">Contactez-nous</a></li>
        </ul>
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="section-title">
          <h2>Contactez-nous pour vos projets</h2>
        </div>
              ...
              <div class="col-md-12 col-lg-8 col-xl-10">
                ...
                <div class="pt-3 pe-3" data-mdb-perfect-scrollbar="true"
                  ...
                  <div class="d-flex flex-row justify-content-end">
                    ...
                    <img src="/design/images/team/team-4.jpg" alt="avatar 1" style="width: 45px; height: 100%; border-radius: 50%;">
                  </div>
                ...
                <div class="text-muted d-flex justify-content-start align-items-center pe-3 pt-3 mt-2">
                  ...
                  <a class="ms-3" href="#!"><i cl/design/imagesass="bi bi-send"></i></a>
                </div>
