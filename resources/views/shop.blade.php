...
<head>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="/design//design/assets/img/favicon.ico">
        ...
        <div class="preloader d-flex align-items-center justify-content-center">
            <div class="preloader-inner position-relative">
                ...
                <div class="preloader-img pere-text">
                    <img src="/design//design/assets/img/logo/logo.png" alt="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="main-header header-sticky">
                <div class="container-fluid">
                    <div class="menu-wrapper">
                        <!-- Logo -->
                        <div class="logo">
                            <a href="index.html"><img src="/design//design/assets/img/logo/logo.png" alt=""></a>
                        </div>
                        <!-- Main-menu -->
                        ...
                        <div class="header-right">
                            <ul>
                                ...
                                <li> <a href="/connexion"><span class="flaticon-user"></span></a></li>
                                <li><a href="/connexion"><span class="flaticon-shopping-cart"></span></a> </li>
                            </ul>
                        </div>
                    </div>
                    <!-- Mobile Menu -->
                    ...
                    <div class="properties__button">
                        ...
                        <nav>                                                      
                            <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                <a class="nav-item nav-link active" id="nav-home-tab" data-toggle="tab" href="#nav-home" role="tab" aria-controls="nav-home" aria-selected="true">Nouveaux Produits</a>
                                ...
                                <a class="nav-item nav-link" id="nav-contact-tab" data-toggle="tab" href="#nav-contact" role="tab" aria-controls="nav-contact" aria-selected="false"> Par Tendances </a>
                            </div>
                        </nav>
                        <!--End Nav Button  -->
                    </div>
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                                <div class="single-popular-items mb-50 text-center">
                                    <div class="popular-img">
                                        ...
                                        <div class="img-cap">
                                            <span><a href="/product_details">Acheter</a> </span>
                                        </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="index.html"><img src="/design//design/assets/img/logo/logo2_footer.png" alt=""></a>
                                </div>
